...
function resetDiscussions() {
    ...
    // Additionally, you may want to remove the displayed questions from the UI
    // Here you can add code to remove the displayed questions from the UI
}
setInterval(resetDiscussions, 1000); // Reset discussions every hour (3600000 milliseconds)
